...
$JAVA32 -d32  -Dchameleon.log.level=ERROR -Dcom.trolltech.qt.library-path-override=qt/lib de.akquinet.gomobile.chameria.launcher.Launcher  --config=conf/chameleon.properties  --deploy=deploy "$@"
