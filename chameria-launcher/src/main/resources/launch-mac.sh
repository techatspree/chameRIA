...
java -d32 -Dchameleon.log.level=ERROR -Dcom.trolltech.qt.library-path-override=qt/lib -XstartOnFirstThread de.akquinet.chameria.launcher.Launcher  --config=conf/chameleon.properties  --deploy=deploy "$@"
