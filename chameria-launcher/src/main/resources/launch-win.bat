...
java -Dchameleon.log.level=ERROR -Dcom.trolltech.qt.library-path-override=qt/bin de.akquinet.gomobile.chameria.launcher.Launcher  --config=conf/chameleon.properties --deploy=deploy %*