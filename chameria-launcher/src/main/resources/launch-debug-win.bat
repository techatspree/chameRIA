...
java -Dchameleon.log.level=INFO -Dcom.trolltech.qt.library-path-override=qt/bin de.akquinet.gomobile.chameria.launcher.Launcher  --config=conf/chameleon.properties --debug --deploy=deploy %*